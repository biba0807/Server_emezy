...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class Currency : IMessage<Currency>, IMessage, IEquatable<Currency>, IDeepCloneable<Currency>
	{
		...
		[DebuggerNonUserCode]
		public static MessageParser<Currency> Parser => _parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => CurrencyMessageReflection.Descriptor.MessageTypes[0];
		...
		[DebuggerNonUserCode]
		public RepeatedField<int> ExchangableCurrencies => exchangableCurrencies_;
