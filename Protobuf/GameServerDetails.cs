...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class GameServerDetails : IMessage<GameServerDetails>, IMessage, IEquatable<GameServerDetails>, IDeepCloneable<GameServerDetails>
	{
		...
		[DebuggerNonUserCode]
		public static MessageParser<GameServerDetails> Parser => _parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => MatchmakingMessageReflection.Descriptor.MessageTypes[0];
