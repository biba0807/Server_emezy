...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class Lobby : IMessage<Lobby>, IMessage, IEquatable<Lobby>, IDeepCloneable<Lobby>
	{
		...
		private static readonly FieldCodec<PlayerFriend> _repeated_spectators_codec = FieldCodec.ForMessage(106u, PlayerFriend.Parser);

		private readonly RepeatedField<PlayerFriend> spectators_ = new RepeatedField<PlayerFriend>();

		public const int SpectatorInvitesFieldNumber = 14;

		private static readonly FieldCodec<PlayerFriend> _repeated_spectatorInvites_codec = FieldCodec.ForMessage(114u, PlayerFriend.Parser);

		private readonly RepeatedField<PlayerFriend> spectatorInvites_ = new RepeatedField<PlayerFriend>();

		[DebuggerNonUserCode]
		public static MessageParser<Lobby> Parser => _parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => MatchmakingMessageReflection.Descriptor.MessageTypes[1];
		...
		[DebuggerNonUserCode]
		public MapField<string, string> Data => data_;

		[DebuggerNonUserCode]
		public RepeatedField<PlayerFriend> Members => members_;

		[DebuggerNonUserCode]
		public RepeatedField<PlayerFriend> Invites => invites_;
		...
		[DebuggerNonUserCode]
		public RepeatedField<PlayerFriend> Spectators => spectators_;

		[DebuggerNonUserCode]
		public RepeatedField<PlayerFriend> SpectatorInvites => spectatorInvites_;
		...
		public bool Equals(Lobby other)
		{
			...
			if (MaxSpectators != other.MaxSpectators)
			{
				return false;
			}
			if (!spectators_.Equals(other.spectators_))
			{
				return false;
			}
			if (!spectatorInvites_.Equals(other.spectatorInvites_))
			{
				return false;
			}
			return true;
		...
		public override int GetHashCode()
		{
			...
			if (MaxSpectators != 0)
			{
				num ^= MaxSpectators.GetHashCode();
			}
			num ^= spectators_.GetHashCode();
			return num ^ spectatorInvites_.GetHashCode();
		}
		...
		public int CalculateSize()
		{
			...
			if (MaxSpectators != 0)
			{
				num += 1 + CodedOutputStream.ComputeInt32Size(MaxSpectators);
			}
			num += spectators_.CalculateSize(_repeated_spectators_codec);
			return num + spectatorInvites_.CalculateSize(_repeated_spectatorInvites_codec);
		}
