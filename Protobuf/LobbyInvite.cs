...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class LobbyInvite : IMessage<LobbyInvite>, IMessage, IEquatable<LobbyInvite>, IDeepCloneable<LobbyInvite>
	{
		...
		private LobbyPlayerType playerType_ = LobbyPlayerType.Member;

		[DebuggerNonUserCode]
		public static MessageParser<LobbyInvite> Parser => _parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => MatchmakingMessageReflection.Descriptor.MessageTypes[2];
		...
		[DebuggerNonUserCode]
		public LobbyPlayerType PlayerType
		{
			get
			{
				return playerType_;
		...
		public int CalculateSize()
		{
			...
			if (PlayerType != 0)
			{
				num += 1 + CodedOutputStream.ComputeEnumSize((int)PlayerType);
			}
			return num;
		}
		...
		public void MergeFrom(CodedInputStream input)
		{
			...
			while ((num = input.ReadTag()) != 0)
			{
				...
				case 24u:
					...
					break;
				case 32u:
					playerType_ = (LobbyPlayerType)input.ReadEnum();
					break;
				}
			}
		}
