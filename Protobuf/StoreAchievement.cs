...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class StoreAchievement : IMessage<StoreAchievement>, IMessage, IEquatable<StoreAchievement>, IDeepCloneable<StoreAchievement>
	{
		...
		[DebuggerNonUserCode]
		public static MessageParser<StoreAchievement> Parser => _parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => PlayerStatsMessageReflection.Descriptor.MessageTypes[5];
