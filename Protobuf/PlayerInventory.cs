...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class PlayerInventory : IMessage<PlayerInventory>, IMessage, IEquatable<PlayerInventory>, IDeepCloneable<PlayerInventory>
	{
		...
		[DebuggerNonUserCode]
		public static MessageParser<PlayerInventory> Parser => _parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => InventoryMessageReflection.Descriptor.MessageTypes[0];
