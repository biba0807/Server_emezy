...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class Stats : IMessage<Stats>, IMessage, IEquatable<Stats>, IDeepCloneable<Stats>
	{
		...
		[DebuggerNonUserCode]
		public static MessageParser<Stats> Parser => _parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => PlayerStatsMessageReflection.Descriptor.MessageTypes[0];

		[DebuggerNonUserCode]
		MessageDescriptor IMessage.Descriptor => Descriptor;

		[DebuggerNonUserCode]
		public RepeatedField<PlayerStat> Stat => stat_;

		[DebuggerNonUserCode]
		public RepeatedField<Achievement> Achievement => achievement_;
