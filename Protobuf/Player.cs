...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class Player : IMessage<Player>, IMessage, IEquatable<Player>, IDeepCloneable<Player>
	{
		...
		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => PlayerMessageReflection.Descriptor.MessageTypes[4];
		...
		public override int GetHashCode()
		{
			...
			{
				num ^= RegistrationDate.GetHashCode();
			}
			if (attributes_ != null)
			{
		...
		public int CalculateSize()
		{
			...
			if (RegistrationDate != 0)
			{
				num += 1 + CodedOutputStream.ComputeInt64Size(RegistrationDate);
			}
			if (attributes_ != null)
			{
