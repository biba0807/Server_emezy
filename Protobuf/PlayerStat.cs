...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class PlayerStat : IMessage<PlayerStat>, IMessage, IEquatable<PlayerStat>, IDeepCloneable<PlayerStat>
	{
		...
		[DebuggerNonUserCode]
		public static MessageParser<PlayerStat> Parser => _parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => PlayerStatsMessageReflection.Descriptor.MessageTypes[1];
