...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class UserConfigBinary : IMessage<UserConfigBinary>, IMessage, IEquatable<UserConfigBinary>, IDeepCloneable<UserConfigBinary>
	{
		...
		[DebuggerNonUserCode]
		public static MessageParser<UserConfigBinary> Parser => _parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => CommonMessageReflection.Descriptor.MessageTypes[5];
