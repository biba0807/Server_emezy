...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class Dictionary : IMessage<Dictionary>, IMessage, IEquatable<Dictionary>, IDeepCloneable<Dictionary>
	{
		...
		[DebuggerNonUserCode]
		public static MessageParser<Dictionary> Parser => _parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => CommonMessageReflection.Descriptor.MessageTypes[0];

		[DebuggerNonUserCode]
		MessageDescriptor IMessage.Descriptor => Descriptor;

		[DebuggerNonUserCode]
		public MapField<string, string> Content => content_;
