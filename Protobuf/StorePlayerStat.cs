...
namespace Axlebolt.Bolt.Protobuf
{
	public sealed class StorePlayerStat : IMessage<StorePlayerStat>, IMessage, IEquatable<StorePlayerStat>, IDeepCloneable<StorePlayerStat>
	{
		...
		[DebuggerNonUserCode]
		public static MessageParser<StorePlayerStat> Parser => _parser;

		[DebuggerNonUserCode]
		public static MessageDescriptor Descriptor => PlayerStatsMessageReflection.Descriptor.MessageTypes[4];
